...
left_cycle_shift_table = [1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1]

table = {"PC1": pc1_table, "PC2": pc2_table, "SBOX": sbox,
         "P": p_table, "E": e_table, "S": syoki_table,
         "Lcs": left_cycle_shift_table}


#a,b,c = map(int,input().split())
#print(table["SBOX"][a][b][c])
#for i,j in enumerate(kaiten_shift):
#    print(i,kaiten_shift[i])
